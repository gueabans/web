...
<header id="home">
    <nav id="theMenu" class="menu">
        ...
        <div id="menu-options" class="menu-wrap">
            ...
            <!--PERSONAL LOGO-->
            <div class="logo-flat">
                <img alt="personal-logo" class="img-responsive" src="images/aban.png">
            </div>
            <br>
            ...
            <a href="#education"><i class="title-icon fa fa-graduation-cap"></i>Pendidikan</a>
            <a href="#skills"><i class="title-icon fa fa-sliders"></i>Keahlian</a>
            <a href="#experience"><i class="title-icon fa fa-suitcase"></i>Pengalaman Kerja</a>
            <a href="#portfolios"><i class="title-icon fa fa-archive"></i>Portfolios</a>
            <a href="#interest"><i class="title-icon fa fa-heart"></i>Hobi</a>
                                ...
                                <div class="infos">
                                    <ul class="profile-list">
                                        <li class="clearfix">
                                            ...
                                            <span class="content">gueabans@gmail.com</span>
                                        </li>
                                        <li class="clearfix">
                                            <span class="title"><i class="material-icons">language</i></span>
                                            <span class="content">www.gueabans.com</span>
                                        </li>
                                        <li class="clearfix">
                                            <span class="title"><i class="fa fa-skype" aria-hidden="true"></i></span>
                                            <span class="content">@gueabans</span>
                                        </li>
                                        <li class="clearfix">
                                            <span class="title"><i class="material-icons">phone</i></span>
                                            <span class="content">+62 82298000475</span>
                                        </li>
                                        <li class="clearfix">
                                            <span class="title"><i class="material-icons">place</i></span>
                                            <span class="content">Jl. Budi Mulya No.19 , Pademangan- Jakarta Utara</span>
                                        </li>
...
<section id="education" class="section">
    <div class="container">
        ...
        <div class="section-title">
            <h4 class="text-uppercase text-center"><i class="title-icon fa fa-graduation-cap"></i>Pendidikan </h4>
        </div>
        ...
        <div id="timeline-education">
            ...
            <div class="timeline-block">
                ...
                <div class="card timeline-content">
                    <div class="card-content">
                        <!-- TIMELINE TITLE -->
                        <h6 class="timeline-title">Pendidikan Dasar </h6>
                        <!-- TIMELINE TITLE INFO -->
                        <div class="timeline-info">
                            <h6>
                                <small>SD Ciboboko</small>
                            </h6>
                            <h6>
                                <small>Juli 2001 - Juli 2006</small>
                            </h6>
                        </div>
                        <!-- TIMELINE PARAGRAPH -->
                        <p>
                            Saya menyelesaikan pendidikan dasar saya dari institusi bergengsi ini. Saya berhasil menyelesaikan semua mata pelajaran dengan baik...
                        </p>
            ...
            <div class="timeline-block">
                ...
                <div class="card timeline-content">
                    <div class="card-content">
                        ...
                        <div class="timeline-info">
                            <h6>
                                <small>MtsN 4 Sumedang</small>
                            </h6>
                            <h6>
                                <small>Juli 2006 - Juli 2009</small>
                            </h6>
                        </div>
                        <!-- TIMELINE PARAGRAPH -->
                        <p>
                            Saya menyelesaikan pendidikan Menengah saya dari institusi bergengsi ini. Saya berhasil menyelesaikan semua mata pelajaran dengan baik.  
                        </p>
						<!-- BUTTON TRIGGER MODAL -->
            ...
            <div class="timeline-block">
                ...
                <div class="card timeline-content">
                    <div class="card-content">
                        ...
                        <div class="timeline-info">
                            <h6>
                                <small>SMA Negeri Jatinunggal</small>
                            </h6>
                            <h6>
                                <small>Juli 2009 - Juli 2012</small>
                            </h6>
                        </div>
                        <!-- TIMELINE PARAGRAPH -->
                        <p>
                             Saya menyelesaikan pendidikan SMA saya dari institusi bergengsi ini. Saya berhasil menyelesaikan semua mata pelajaran dengan baik...
                        </p>
						<!-- BUTTON TRIGGER MODAL -->
                        <a href="#" class="modal-dot" data-toggle="modal" data-target="#myModal-2">
                            <i class="fa fa-ellipsis-h" aria-hidden="true"></i>
            ...
            <div class="timeline-block">
                ...
                <div class="card timeline-content">
                    <div class="card-content">
                        <!-- TIMELINE TITLE -->
                        <h6 class="timeline-title">Universitas</h6>
                        <!-- TIMELINE TITLE INFO -->
                        <div class="timeline-info">
                            <h6>
                                <small>Universitas Bungkarno</small>
                            </h6>
                            <h6>
                                <small>Maret 2014 - Mar 2018</small>
                            </h6>
                        </div>
                        <!-- TIMELINE PARAGRAPH -->
                        <p>
...
<section id="skills" class="section">
    <div class="container">
        <!-- SECTION TITLE -->
        <div class="section-title">
            <h4 class="text-uppercase text-center"><i class="title-icon fa fa-sliders"></i>Keterampilan</h4>
        </div>
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
...
<section id="experience" class="section">
    <div class="container">
        <!-- SECTION TITLE -->
        <div class="section-title">
            <h4 class="text-uppercase text-center"><i class="title-icon fa fa-suitcase"></i>Pengalaman Kerja</h4>
        </div>
        ...
        <div id="timeline-experience">
            ...
            <div class="timeline-block">
                ...
                <div class="card timeline-content">
                    <div class="card-content">
                        <!-- TIMELINE TITLE -->
                        <h6 class="timeline-title">IT Helpdesk</h6>
                        <!-- TIMELINE TITLE INFO -->
                        <div class="timeline-info">
                            <h6>
                                <small>PT.Komputerindo</small>
                            </h6>
                            <h6>
                                <small>Jan 2014 - Des 2015</small>
                            </h6>
                        </div>
                        <!-- TIMELINE PARAGRAPH -->
                        <p>
                            Saya memulai karier IT  saya di sini, menghabiskan waktu setahun untuk  belajar dan bekerja dalam berbagai aspek IT Suport.
                        </p>
                        <!-- BUTTON TRIGGER MODAL -->
                ...
                <div class="card timeline-content">
                    <div class="card-content">
                        ...
                        <div class="timeline-info">
                            ...
                            <h6>
                                <small>Jan 2015 - Des 2016</small>
                            </h6>
                        </div>
                        <!-- TIMELINE PARAGRAPH -->
                        <p>
                            Saya memulai menjadi administrator stok barang saya di sini, menghabiskan waktu setahun untuk  belajar dan bekerja di perusahaan penjualan online.
                        </p>
						<!-- BUTTON TRIGGER MODAL -->
                        <a href="#" class="modal-dot" data-toggle="modal" data-target="#myModal-4">
                            <i class="fa fa-ellipsis-h" aria-hidden="true"></i>
            ...
            <div class="timeline-block">
                ...
                <div class="card timeline-content">
                    <div class="card-content">
                        ...
                        <div class="timeline-info">
                            <h6>
                                <small>SMP Islam Tambora</small>
                            </h6>
                            <h6>
                                <small>Jan 2016 - Desember 2018 </small>
                            </h6>
                        </div>
                        <!-- TIMELINE PARAGRAPH -->
                        <p>
...
<section id="interest" class="section">
    <div class="container">
        <!-- SECTION TITLE -->
        <div class="section-title">
            <h4 class="text-uppercase text-center"><i class="title-icon fa fa-heart"></i>HOBI</h4>
        </div>
        ...
        <div id="interest-card" class="card">
            ...
            <div class="card-content">
                <p>
                    Pertama-tama saya suka musik, musik pop adalah favorit saya. Suka menonton sepak bola, film, dan bermain game dengan teman-teman saya. Saya menghabiskan cukup banyak waktu dalam perjalanan dan fotografi, ini membuat saya tetap segar untuk lingkungan kerja. Saya juga menghabiskan waktu dengan menjadi sukarelawan.
                </p>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-md-7 col-sm-12 col-xs-12">
                ...
                <div id="map-card" class="card">
					...
					<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3960.696497746986!2d108.11990231402065!3d-6.926835294995192!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e6f3215075dffb9%3A0xfd6bbd8b3c6bee4b!2sGue+Abans!5e0!3m2!1sid!2sid!4v1541172876303" width="550" height="415" frameborder="0" style="border:0" allowfullscreen></iframe>
                </div>
            </div>
...
<footer>
    <div class="container">
        <!--FOOTER DETAILS-->
        <p class="text-center">
            © 2018 | gueaban{dot}com | Ciboboko{dot}net
            </a>
        </p>
    </div>
</footer>
